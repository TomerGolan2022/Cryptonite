              ...
              <div class="card-body" id="cardBody${index}">
               <div class="form-check form-switch position-relative end-0" style="transform: translateX(90%);">
                  ...
                  <label
                     ...
                     <img src="${coins[index].image.large}" class="coin-img"/>
                     ...
                     <div id="collapseDiv${index}">
                       <div class="collapse" id="collapse${index}">
                         <div class="card card-body data">
                           <span>
                            ${coins[index].market_data.current_price.usd} $ </br>
                            ${coins[index].market_data.current_price.eur} € </br>
                            ${coins[index].market_data.current_price.ils} ₪
                           </span>
                         </div>
                       </div>
                     </div> 
